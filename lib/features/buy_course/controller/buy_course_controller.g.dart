...
class BuyCourseControllerFamily extends Family<AsyncValue<String?>> {
  ...
  /// See also [buyCourseController].
  BuyCourseControllerProvider call({required int index}) {
    return BuyCourseControllerProvider(index: index);
  }
...
class BuyCourseControllerProvider extends AutoDisposeFutureProvider<String?> {
  /// See also [buyCourseController].
  BuyCourseControllerProvider({required int index})
    : this._internal(
        (ref) =>
            buyCourseController(ref as BuyCourseControllerRef, index: index),
