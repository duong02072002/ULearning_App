...
import 'package:flutter_ulearning_app/common/widgets/popup_messages.dart';
import 'package:flutter_ulearning_app/features/sign_up/provider/register_notifier.dart';
import 'package:flutter_ulearning_app/features/sign_up/repo/sign_up_repo.dart';
  ...
  Future<void> handleSignUp() async {
    ...
    try {
      ...
      if (credential.user != null) {
        ...
        //set user photo url
        toastInfo(
          "Asn email has been to sent verify your account. Please open that email and confirm your identity",
        );
        context.pop();
      }
